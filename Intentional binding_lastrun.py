...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='C:\\Users\\Sanjana\\Desktop\\PSYCHOLOGY LAB\\Intentional binding_lastrun.py',
...
polygon_3 = visual.ShapeStim(
    win=win, name='polygon_3', vertices='star7',
    size=[1.0, 1.0],
...
text = visual.TextStim(win=win, name='text',
    text='report the delay between the key press and the beep(0-999); Click submit after entering the value ',
    font='Open Sans',
...
trials = data.TrialHandler(nReps=33.0, method='random', 
    ...
    trialList=data.importConditions('data/binding.xlsx'),
